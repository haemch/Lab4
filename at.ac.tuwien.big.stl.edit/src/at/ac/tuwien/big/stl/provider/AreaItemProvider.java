...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.stl.Area} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AreaItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(STLPackage.Literals.AREA__COMPONENTS);
			childrenFeatures.add(STLPackage.Literals.AREA__CONNECTORS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Area.class)) {
			...
			case STLPackage.AREA__CONNECTORS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(STLPackage.Literals.AREA__COMPONENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(STLPackage.Literals.AREA__CONNECTORS,
				 STLFactory.eINSTANCE.createConnector()));
	}
