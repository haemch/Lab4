...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.stl.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_entry_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_entry_feature", "_UI_Connector_type"),
				 STLPackage.Literals.CONNECTOR__ENTRY,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addExitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_exit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_exit_feature", "_UI_Connector_type"),
				 STLPackage.Literals.CONNECTOR__EXIT,
				 true,
				 false,
				 true,
				 null,
