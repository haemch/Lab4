...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.stl.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_System_areas_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_System_areas_feature", "_UI_System_type"),
				 STLPackage.Literals.SYSTEM__AREAS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(STLPackage.Literals.SYSTEM__AREAS);
			childrenFeatures.add(STLPackage.Literals.SYSTEM__ITEM_TYPES);
		}
	...
	public String getText(Object object) {
		String label = ((at.ac.tuwien.big.stl.System)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(at.ac.tuwien.big.stl.System.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(STLPackage.Literals.SYSTEM__ITEM_TYPES,
