...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.stl.Service} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ServiceItemProvider extends NamedElementItemProvider {
	...
	protected void addProcessingTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_processingTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_processingTime_feature", "_UI_Service_type"),
				 STLPackage.Literals.SERVICE__PROCESSING_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addReliabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Service_reliability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Service_reliability_feature", "_UI_Service_type"),
				 STLPackage.Literals.SERVICE__RELIABILITY,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(STLPackage.Literals.SERVICE__PARAMETERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(STLPackage.Literals.SERVICE__PARAMETERS,
				 STLFactory.eINSTANCE.createParameter()));
	}
